(function () {
  ...
  var I18N = {
    pt: {
      ...
      'pub.yolo.title': 'A Comprehensive Assessment of Optimized YOLO Architectures for Edge and Real-Time Applications',
      'pub.yolo.desc': 'Artigo publicado na ICCT-Pacific 2026. Avaliação abrangente de arquiteturas YOLO otimizadas para aplicações em tempo real.',
      'pub.quant.title': 'Importance-Aware Quantization Strategy for Layer-Sensitive YOLO Architectures',
      'pub.quant.desc': 'Artigo publicado na ICCT-Pacific 2026. Estratégia de quantização baseada em importância para arquiteturas YOLO.',
      'pub.carotid.title': 'Detection and Segmentation of Carotid Atheroma Calcification in Dental Panoramic Radiographs Using a Hybrid Deep Learning Model',
      'pub.carotid.desc': 'Artigo em pre-print (Research Square). Detecção e segmentação de calcificação de ateroma carotídeo usando um modelo híbrido.',
    ...
    en: {
      ...
      'pub.yolo.title': 'A Comprehensive Assessment of Optimized YOLO Architectures for Edge and Real-Time Applications',
      'pub.yolo.desc': 'Paper published at ICCT-Pacific 2026. Comprehensive assessment of optimized YOLO architectures for real-time applications.',
      'pub.quant.title': 'Importance-Aware Quantization Strategy for Layer-Sensitive YOLO Architectures',
      'pub.quant.desc': 'Paper published at ICCT-Pacific 2026. Importance-aware quantization strategy for layer-sensitive YOLO architectures.',
      'pub.carotid.title': 'Detection and Segmentation of Carotid Atheroma Calcification in Dental Panoramic Radiographs Using a Hybrid Deep Learning Model',
      'pub.carotid.desc': 'Pre-print paper (Research Square). Detection and segmentation of carotid atheroma calcification using a hybrid model.',
      'pub.msc.title': 'Deforestation Detection in SAR Images using Deep Neural Networks',
